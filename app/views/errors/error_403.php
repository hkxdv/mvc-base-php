<div class="flex flex-col justify-center items-center">
    <div class="card text-center p-10 max-w-lg">
        <div class="relative mb-6">
            <h1 class="text-9xl font-bold relative z-10" style="color: var(--text-primary); opacity: 0.9;">403</h1>
            <div class="absolute -top-10 -left-10 w-full h-full flex justify-center items-center">
                <div class="text-9xl font-bold" style="color: var(--accent-color); opacity: 0.1;">403</div>
            </div>
        </div>
        <h2 class="text-3xl font-semibold mb-4" style="color: var(--accent-color);"><?php echo isset($data['titulo']) ? $data['titulo'] : 'Acceso Prohibido'; ?></h2>
        <p class="text-xl mb-8" style="color: var(--text-secondary);"><?php echo isset($data['mensaje']) ? $data['mensaje'] : 'No tienes permisos para acceder a este recurso.'; ?></p>
        <div class="flex flex-col md:flex-row justify-center gap-4">
            ...
            <button onclick="history.back()" class="btn-secondary inline-flex items-center px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105">

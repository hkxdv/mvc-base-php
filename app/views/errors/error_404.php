<div class="flex flex-col justify-center items-center">
    <div class="card text-center p-10 max-w-lg">
        <div class="relative mb-6">
            <h1 class="text-9xl font-bold relative z-10" style="color: var(--text-primary); opacity: 0.9;">404</h1>
            <div class="absolute -top-10 -left-10 w-full h-full flex justify-center items-center">
                <div class="text-9xl font-bold" style="color: var(--accent-color); opacity: 0.1;">404</div>
            </div>
        </div>
        <h2 class="text-3xl font-semibold mb-4" style="color: var(--accent-color);"><?php echo isset($data['titulo']) ? $data['titulo'] : 'Página No Encontrada'; ?></h2>
        <p class="text-xl mb-8" style="color: var(--text-secondary);"><?php echo isset($data['mensaje']) ? $data['mensaje'] : 'Lo sentimos, la página que buscas no existe.'; ?></p>

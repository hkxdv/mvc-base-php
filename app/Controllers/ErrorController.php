...
/**
 * Clase que gestiona los errores del sistema
 */
class ErrorController
{
     ...
     * @return void
     */
    private static function renderizarError($vista, $data = [])
    {
    ...
    static public function error404($mensaje = "")
    {
        ...
        self::renderizarError("app/views/errors/error_404.php", $data);
    }
    ...
    static public function error403($mensaje = "")
    {
        ...
        self::renderizarError("app/views/errors/error_403.php", $data);
    }
    ...
    static public function errorDb($mensaje = "")
    {
        ...
        self::renderizarError("app/views/errors/error_db.php", $data);
    }
    ...
    static public function errorGenerico($codigo, $titulo, $mensaje, $mensajeDetallado = "")
    {
        ...
        if (!empty($mensajeDetallado)) {
            $data["mensaje_detallado"] = $mensajeDetallado;
        }
        ...
        self::renderizarError("app/views/errors/error_generico.php", $data);
    }
}
